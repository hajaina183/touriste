...
public class DetailPlage3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_plage3);
        ...
        p.getData(new Callback<List<Plage>>() {
            ...
            public void onResponse(Call<List<Plage>> call, Response<List<Plage>> response) {
                if (response.isSuccessful()) {
                    ...
                    titre.setText(plages.get(2).getNom()+" se trouve à " + plages.get(2).getLieu());
                    //titre.setText(userId);
                    nomParc = plages.get(2).getNom() ;
                    descrption.setText(plages.get(2).getDescription());
                    int resId = getResources().getIdentifier(plages.get(2).getPhoto(), "drawable", getPackageName());
        ...
        imageViewSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!commentaire.isEmpty()) {
                    ...
                    Toast.makeText(DetailPlage3.this, "Veuillez saisir un commentaire.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
